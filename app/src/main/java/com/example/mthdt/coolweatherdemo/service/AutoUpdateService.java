package com.example.mthdt.coolweatherdemo.service;
...
import com.example.mthdt.coolweatherdemo.util.Utility;
...
public class AutoUpdateService extends Service {
    ...
    private void updateWeather() {
        ...
        if (weatherString != null) {
            ...
            String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=3ffd30eea7984159b2505f7cc6e24360";
